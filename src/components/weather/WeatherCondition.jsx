...
function WeatherCondition() {
  ...
  const { description, maxTemperature, minTemperature, humidity, cloudPercentage, wind } = weatherData;
  return (
    <div>
      <p className="text-sm lg:text-lg font-bold uppercase mb-8">{description}</p>
